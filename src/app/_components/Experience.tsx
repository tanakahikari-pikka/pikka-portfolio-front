	...
	const workExperience = [
		{
			...
			description: "toridori baseのアプリ開発を担当。",
			achievements: [
				"toridori baseのアプリ開発を担当。ジャンル機能・検索UIの改善などを行った。",
				"toridori baseのバックエンド開発を担当。",
				"サービスのユーザーデータを一元化し、共通のユーザーで各サービスを利用できる統合DBおよびユーザーデータを提供するAPIの構築を担当。",
			],
			technologies: [
				"Ruby",
				"Ruby on Rails",
		...
		},
		{
			...
			description: "主に構築されたシステムのQAを担当。",
			achievements: [
				"既存システムのQAを担当し、バグ出し〜修正まで一元化して運用。",
			],
	...
	const educationExperience = [
		{
			...
			description:
				"Web技術と人工知能の研究に従事。修士論文では自然言語処理を用いたWebコンテンツの自動分類システムを開発。",
			achievements: [
		...
		},
		{
			...
			description:
				"コンピュータサイエンスを専攻し、特にWebアプリケーション開発とデータベース設計に注力。",
			achievements: [
				"卒業研究でSNS分析ツールを開発",
...
const ExperienceCard = ({
	...
	return (
		<motion.div variants={variants} className="mb-12 relative">
			...
			<div className="bg-gradient-to-br from-indigo-950/50 to-black/70 backdrop-blur-sm rounded-xl overflow-hidden border border-indigo-500/10 shadow-xl shadow-purple-500/5 hover:shadow-purple-500/10 hover:border-indigo-500/30 transition-all duration-300 p-6">
				...
				{/* 説明 */}
				<p className="text-indigo-200 mb-4">{data.description}</p>
